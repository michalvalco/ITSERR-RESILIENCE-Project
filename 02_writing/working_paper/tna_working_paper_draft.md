...
The **BiblIndex** project at Lyon provides a comprehensive index of biblical quotations in patristic literature, offering both a potential data source and a validation resource for any citation detection system. Cross-disciplinary methodological transfer has also proven fruitful: sequence-alignment methods from bioinformatics, including BLAST, have been adapted for text reuse detection in historical corpora (Vesanto et al., 2017), while patristic text reuse detection employs specialised tools such as TRACER — a reminder that computational humanities can draw productively on methods from very different fields.
...
Anthony Le Duc, SVD, Executive Director of the Asian Research Center for Religion and Social Communication, represents the most active contemporary voice on AI and theological method. Le Duc's concept of "cybertheology" (Le Duc, n.d.; cf. Le Duc, 2026) establishes a distinct disciplinary space concerned with how digital environments reshape theological reflection. His February 2026 keynote argues that "technology is never neutral" and warns of "algorithmic mediation" governing human choice. Heidi Campbell (Texas A&M) frames religious AI tools as "charismatic technologies" — a concept directly relevant to understanding how such tools accrue authority that may or may not be warranted.

The reductionism concern is not culturally parochial. Lewis, Whaanga, and Yolgörmez (2025), presenting the Abundant Intelligences research programme in *AI & Society*, argue that Western rationalist epistemologies exclude Indigenous ways of knowing, producing AI systems structurally incapable of representing relational, oral, and performative knowledge traditions — demonstrating that the flattening of sacred meaning by computational systems is an ecumenical problem extending well beyond Christianity. Ahmad and Ahmad Ghafar (2025), examining AI as interpretive aid in Qur'anic stylistics, encounter the theological barrier of *i'jaz* (the inimitability doctrine), which posits that the Qur'an's linguistic form is itself miraculous and therefore resistant to computational reduction in ways that have no precise parallel in Protestant hermeneutics. They propose a human-in-the-loop model wherein AI functions as a *musāʿid* (supportive tool), not a *muḥakkim* (arbiter) of meaning — an Islamic formulation that converges remarkably with the personalist design principles articulated in Section 6 of this synthesis. These cross-religious cases strengthen the argument that design anti-patterns (resist decontextualisation, resist epistemic gnosticism) are not Western Christian concerns projected onto other traditions but responses to a structural feature of how computational systems interact with sacred meaning.
...
The Rome Call for AI Ethics (Pontifical Academy for Life, 2020), signed initially by Microsoft, IBM, and FAO, and subsequently expanded to representatives of all three Abrahamic faiths (2023) and additional technology companies, establishes six principles: Transparency, Inclusion, Responsibility, Impartiality, Reliability, and Security/Privacy. The Vatican's declaration *Dignitas Infinita* (Dicastery for the Doctrine of the Faith, 2024) expanded these principles into a comprehensive framework for human dignity in the digital age, and the joint note *Antiqua et Nova* (Dicastery for the Doctrine of the Faith & Dicastery for Culture and Education, 2025) specifically addresses the relationship between AI and human intelligence in the context of Catholic anthropology. The 2025 *Linee Guida in Materia di Intelligenza Artificiale* defines AI as "a gift of human creativity, which itself is a gift from God" while prohibiting subliminal manipulation and discriminatory inferences. Pope Leo XIV stated that "access to data must not be confused with intelligence" and that AI must account for "the well-being of the human person not only materially, but also intellectually and spiritually."
...
The **Czech Republic's Manuscriptorium** stands as the flagship: approximately 400,000 descriptive records and 110,000 complex digitised documents from more than 180 institutions in approximately twenty countries, encompassing extensive religious content (Manuscriptorium, accessed 14 February 2026). Winner of the inaugural UNESCO Jikji Prize (2005), Manuscriptorium serves as a licensed Europeana domain aggregator and represents the most comprehensive CEE-based digital manuscript infrastructure.
...
Ahmad, H. & Ahmad Ghafar, N. (2025). "AI as Interpretive Aid in Qur'anic Stylistics: Ethical Foundations for Digital Hermeneutics." *International Journal of Arts and Social Science* 8(9). ISSN: 2581-7922.
...
Lewis, J.E., Whaanga, H., & Yolgörmez, C. (2025). "Abundant Intelligences: Placing AI within Indigenous Knowledge Frameworks." *AI & Society* 40(4): 2141–2157. DOI: 10.1007/s00146-024-02099-4.
...
Mellerin, L. (2014). "New Ways of Searching with Biblindex, the Online Index of Biblical Quotations in Early Christian Literature." In C. Clivaz, A. Gregory, & D. Hamidovic (Eds.), *Digital Humanities in Biblical, Early Jewish and Early Christian Studies* (pp. 175–192). Brill. DOI: 10.1163/9789004264441_012.
